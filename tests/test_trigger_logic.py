...
def test_trigger_nu_event():
    xml_tests = [
        ...
        ('Antares_1438351269.yaml', [
            True, False, False, '2022-09-08 01:30:34.201740: Event ID None: The Antares ranking (1) is less than or equal to 2 so triggering. \n']),
        # An antares neutrino we would want to trigger on
        ('IceCube_134191_017593623_0.yaml', [
            True, False, False, '2022-09-08 01:30:34.201740: Event ID None: No thresholds for non Antares telescopes so triggering. \n']),
    ]
