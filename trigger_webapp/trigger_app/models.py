...
class ProposalSettings(models.Model):
    ...
    pending_min_duration_1 = models.FloatField(blank=True, null=True, verbose_name="Min")
    pending_max_duration_1 = models.FloatField(blank=True, null=True, verbose_name="Max")
    pending_min_duration_2 = models.FloatField(blank=True, null=True, verbose_name="Min")
    pending_max_duration_2 = models.FloatField(blank=True, null=True, verbose_name="Max")
