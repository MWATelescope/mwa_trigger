# Generated by Django 4.0.4 on 2023-01-25 05:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.FloatField(default=0.05, verbose_name='Minimum probability for event to be BNS'),
        ),
        migrations.AddField(
            model_name='proposalsettings',
            name='minimum_neutron_star_black_hole_probability',
            field=models.FloatField(default=0.05, verbose_name='Minimum probability for event to be NSBH'),
        ),
        migrations.AddField(
            model_name='proposalsettings',
            name='minimum_neutron_star_probability',
            field=models.FloatField(default=0.05, help_text='PROB_NS - probability that at least one object in the binary has a mass that is less than 3 solar masses', verbose_name='Minimum on the probability that at least one object in the binary has a mass that is less than 3 solar masses'),
        ),
        migrations.AddField(
            model_name='proposalsettings',
