...
urlpatterns = [
    ...
    path('possible_event_association_log/',
         views.PossibleEventAssociationList),
    path('possible_event_association_details/<int:tid>/',
         views.PossibleEventAssociation_details),
    ...
    path('proposal_decision_result/<int:id>/<int:decision>/',
