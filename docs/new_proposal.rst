...
`Edit Proposal Settings <http://127.0.0.1:8000/admin/trigger_app/proposalsettings/>`_
...
`Admin Alert Control <http://127.0.0.1:8000/admin/trigger_app/adminalerts/>`_
...
`User Alert Control  <http://127.0.0.1:8000/user_alert_status/>`_ page.
