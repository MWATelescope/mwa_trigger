...
from mwa_trigger import GRB_fermi_swift

PRETEND = False   # Set to true to trigger event in 'pretend' mode, nopt actually schedule observations.

EVENTHANDLERS = [GRB_fermi_swift.processevent]    # One or more handler functions - all will be called in turn on each XML event.
